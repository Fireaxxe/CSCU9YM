turtles-own [energy age life-span] ;; for keeping track of when the turtle is ready to reproduce and when it will die
...
to setup-turtles
  create-turtles number [setxy random-xcor random-ycor] ;;uses the value of the number slider to create turtles
  ask turtles[
  set age 0
  set life-span random(max-life-span - min-life-span) + min-life-span + 1
  ]
end
  ...
  ask turtles [
    if energy > birth-energy [
      ...
      hatch 1 [
        ...
        set age 0];; give this birth-energy to the offspring
    ]
  ]
end
